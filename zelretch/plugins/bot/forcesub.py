...
from . import BotHelp, Config, Symbols, db, zelretch


@zelretch.bot.on_message(filters.command("forcesub") & Config.AUTH_USERS & filters.group)
...
@zelretch.bot.on_message(filters.command("unforcesub") & Config.AUTH_USERS)
...
@zelretch.bot.on_message(filters.command("listforcesub") & Config.AUTH_USERS)
...
@zelretch.bot.on_message(filters.command("getforcesub") & Config.AUTH_USERS)
...
@zelretch.bot.on_callback_query(filters.regex(r"forcesub"))
