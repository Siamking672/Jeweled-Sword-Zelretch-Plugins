...
async def sticker_to_gif(_, message: Message):
    ...
    hell = await zelretch.edit(message, "Converting ...")
    ...
    if replied_sticker.is_animated:
        ...
        return await zelretch.delete(hell, "Reply to an animated/video sticker.")
    ...
    await zelretch.delete(hell, "Converted to gif successfully!")
...
async def sticker_to_image(_, message: Message):
    ...
    await zelretch.delete(hell, "Converted to image successfully!")
...
async def image_to_sticker(_, message: Message):
    ...
    await zelretch.delete(hell, "Converted to sticker successfully!")
...
async def image_to_file(_, message: Message):
    ...
    await zelretch.delete(hell, "Converted to file successfully!")
...
async def media_to_voice(_, message: Message):
    ...
    if os.path.exists(voice_path):
        ...
        await zelretch.delete(hell, "Converted to voice successfully!")
        os.remove(voice_path)
    else:
        await zelretch.error(hell, f"`{err}`")
...
async def media_to_mp3(_, message: Message):
    ...
    if os.path.exists(mp3_path):
        ...
        await zelretch.delete(hell, "Converted to mp3 successfully!")
        os.remove(mp3_path)
    else:
        await zelretch.error(hell, f"`{stderr}`")
